	...
	<div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <h5 class="text-right">Daily Marketing Sales Report</h5>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-6">
          <form action="{{route('marketingreport.store')}}" method="POST">
              @csrf
              <div class="form-group">
                <label for="at">Date</label>
                <input type="text" class="form-control @error('at') is-invalid @enderror" name="at" id="at" placeholder="Select  Date" value="{{old('at')}}">
                    @error('at')
                  ...
                  <input type="text" id="market" placeholder="Enter market Name" class="form-control @error('market') is-invalid @enderror" name="market" value="{{old('market')}}">
                ...
                <input type="text" id="order" placeholder="Enter order" class="form-control @error('order') is-invalid @enderror" name="order" value="{{old('order')}}">
              ...
              <input type="text" id="delivery" placeholder="Enter delivery" class="form-control @error('delivery') is-invalid @enderror" name="delivery" value="{{old('delivery')}}">
              ...
              <input type="text" id="area" placeholder="Enter Area" class="form-control @error('area') is-invalid @enderror" name="area" value="{{old('area')}}" >
              ...
              <textarea name="comment"  class="form-control @error('area') is-invalid @enderror" id="comment" cols="30" rows="5">{{old('comment')}}</textarea>
          ...
          <div class="form-group">
              <button onclick="reportSubmit()" type="submit" class="btn btn-success">submit</button>
          </div>
