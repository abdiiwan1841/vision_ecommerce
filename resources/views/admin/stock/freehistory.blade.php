        ...
        <div class="card">
            <div class="card-header">
              <div class="row">
                ...
                <div class="col-lg-10">
                  <h5 class="text-right"> ( {{$product->product_name}} ) -  FREE HISTORY </h5>
                </div>
              </div>
            </div>
            <div class="card-body">
              ...
              <table class="table" id="jq_datatables">
                ...
                <tbody>
                  @php
                      ...
                      $sum = 0;
                  @endphp
                  @foreach ($free_history as $item)
                    <tr>
                      <td>{{$i++}}</td>
                      <td>{{Carbon\Carbon::parse($item->sales_at)->format('d-m-y')}}</td>
                      <td>#{{$item->id}}</td> 
