...
@section('content')
  ...
  <div class="row">
        ...
        <div class="p_wrapper">
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-lg-8">
                 <strong class="float-right">EDIT RETURN  #{{$return->id}}</strong> 
              </div>
            </div>
          </div>
    ...
    <div class="col-lg-8">
      ...
      <h4 class="text-center">EDIT RETURN INVOICE #{{$return->id}}</h4>
        <h5 class="date"></h5> <br>
        <div class="row">
            <div class="col-lg-6">
    ...
    if(product_id.length > 0){
        $.get(baseuel+"/api/productinfo/"+product_id, function(data, status){
          if(status === 'success'){
            ...
            if(data.discount_price == null){
              $("#price").val(data.price).removeClass('is-invalid').addClass('is-valid');
            }else{
              $("#price").val(data.discount_price).removeClass('is-invalid').addClass('is-valid');
            }
 ...
 var discount_amount = $(".discount").val();
   if(sessionStorage.posreturnCart.length < 3){
    ...
    $.ajax({
          ...
          url: "{{route('return.update',$return->id)}}",
          type: "PUT",
          dataType: 'json',
