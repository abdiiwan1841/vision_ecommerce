        ...
        <div class="row">
                      ...
                      <div class="bc-item">
                        <label for="bc-{{$brand->id}}">
                          {{$brand->brand_name}}
                            ...
                            @foreach ($request->brand as $brand_item)
                                @if($brand_item == $brand->id)
                                  checked
                                @endif
                            @endforeach
                            @endif
                ...
                <div class="filter-widget">
                    ...
                    <div class="filter-range-wrap">
                        ...
                        <div class="price-range ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content"
                            data-min="{{$request->minamount}}" data-max="{{$request->maxamount}}">
            ...
            <div class="col-lg-9 order-1 order-lg-2">
                ...
                <div class="product-list">
                  ...
                  <h5 class="mb-5"> Filter By Price Applied: <br> <strong>Price Between {{$request->minamount}} To {{$request->maxamount}} @if($request->has('brand')) </strong> <br>
                    And Filter By Brand Applied: <br>
                    <strong>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4 col-sm-6">
                          <div class="product-item">
                              <div class="pi-pic">
                                  <img src="{{asset('public/uploads/products/original/'.$single_product->image)}}" alt="{{$single_product->product_name}}">
