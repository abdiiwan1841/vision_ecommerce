...
<div class="col-lg-12">
    ...
    <form action="{{route('company.update',$company->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-lg-4">
            ...
            <div class="form-group">
            <img  class="img-thumbnail rounded" src="{{asset('public/uploads/favicon/cropped/'.$company->favicon)}}" id="pd_favicon" alt="">
            </div>
        ...
        <div class="col-lg-4">
          ...
          <div class="form-group">
          <img  class="img-thumbnail rounded" src="{{asset('public/uploads/logo/cropped/'.$company->logo)}}" id="pd_image2" alt="">
          </div>
