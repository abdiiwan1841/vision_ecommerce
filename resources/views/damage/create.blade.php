...
@section('content')
  ...
  <div class="row">
           ...
           <div class="row">
            ...
            <div class="col-lg-4">
              <div class="form-group">
                ...
                @endphp
                <input type="text" class="form-control" name="damage_date" id="damage_date" value="{{$mytime->toDateString()}}" readonly>
    ...
    <div class="table-responsive">
      ...
      <button type="button" class="btn btn-warning btn-block"  id="confirm-btn" onclick="confirm_sales()">Confirm</button>
