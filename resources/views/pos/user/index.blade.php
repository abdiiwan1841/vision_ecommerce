        ...
        <tbody>
          ...
          @foreach ($customers as $key =>  $customer)
            ...
            <a href="{{route('customers.edit',$customer['id'])}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
              ...
              <form id="delete-from-{{$customer['id']}}" style="display: inline-block" action="{{route('customers.destroy',$customer['id'])}}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="button" onclick="deleteItem({{$customer['id']}})"  class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></button>
