...
@section('title','Edit Inventory Sales')
@section('content')
  ...
  <div class="row">
    <div class="col-lg-12">
        ...
        <div class="p_wrapper">
          <div class="row">
            ...
            <div class="col-lg-8">
               <strong class="float-right">EDIT SALES INVOICE - # {{$sale->id}}</strong> 
            </div>
          </div>
          <hr>
           <div class="row">
    ...
    <div class="col-lg-12">
      ...
      <h3 class="text-center">SALES INVOICE #{{$sale->id}}</h3>
        <h5 class="date"></h5> <br>
        <div class="row">
            <div class="col-lg-6">
...
function changeDate(){
  $("#sales_date").attr('disabled',false);
}
...
$('.add-to-cart').click(function(event) {
  ...
  $.get(baseuel+"/api/productinfo/"+id, function(data, status){
    ...
    salesCart.addItemToCart(nameSlulg, price, qnty,id,o_name,image);
...
$("#sales_date").change(function(){
  var sd = $("#sales_date").val();
  if(sd.length === 0){
    $("#sales_date").removeClass('is-valid').addClass('is-invalid');
    $(".date_err").removeClass('valid-feedback').addClass('invalid-feedback');;
    $(".date_err").text('Date Field is Required');
  }else{
    $("#sales_date").removeClass('is-invalid').addClass('is-valid');
